...
public class Elements {
	...
	static void getElement(WebDriver driver, ElementsEnum selElement){
        WebElement someBtn = (new WebDriverWait(driver, 10))
                .until(ExpectedConditions.visibilityOfElementLocated(By.xpath(String.format(UNIQUE_ID,
                        selElement.getELEMENT()))));
        someBtn.click();
    }
    ...
    static void chooseKindOfTicket(WebDriver driver, ElementsEnum selElement){
        WebElement someBtn = (new WebDriverWait(driver, 10))
                .until(ExpectedConditions.visibilityOfElementLocated(By.xpath(String.format(KIND_OF_TICKET,
                        selElement.getELEMENT(),selElement.getELEMENT()))));
        someBtn.click();
    }
